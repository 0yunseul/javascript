/*
//0.대입연산자 : =
let k = 10; // k라는 변수를 메모리에 선언하고 숫자타입 데이터 10을 저장한다.
            // 이때, 10이라는 데이터가 k라는 변수로 대입(할당,저장)된다.
console.log("k의 값 : " + k);

//1.산술연산자 : +, -, * ,/, %
//1-1. 문자 연결 연산자 :  + (덧셈이 아닌 문자열끼리 이어서 쓰는 연산자)
let n1 = 10;
let n2 = 50;
...
//6. 삼항 조건 연산자 : 조건 ? true 일때 실행 표현식 : false일때 실행 표현식;
let n1 = 10;
let n2 = 50;
...
//7. 우선순위연산자  : ()
let j = 1 + '100';
console.log(j,typeof j, Number(j), typeof Number(j)); //형 변환
